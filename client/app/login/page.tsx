...
import { Sofa, Mail, Lock, ArrowRight, User, ShieldCheck, Eye, EyeOff, Loader2 } from "lucide-react"
...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      const endpoint = data.role === "seller" ? "http://localhost:5000/api/auth/seller/login" : "http://localhost:5000/api/auth/login"
